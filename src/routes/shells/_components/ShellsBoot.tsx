...
export function ShellsBoot({
  ...
  return (
    <div
      ...
      className={cn(
        "fixed inset-0 z-[var(--z-toast)] flex flex-col items-center justify-center bg-background transition-opacity duration-500 ease-out",
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-2 text-micro uppercase tracking-[0.18em] text-muted-foreground">
        ...
        {/* Width is intrinsic — outer column sizes to the bar (the wider
           ...
           bar's right bracket. */}
        <div className="flex w-fit flex-col gap-2 text-caption">
          ...
          {/* ASCII progress bar — block-cell strip. Brackets stay at the
             surrounding 12px font; cells shrink to 9px so they don't tower
             over the brackets the way full-block glyphs naturally do. */}
          <div aria-hidden className="flex items-baseline gap-2 leading-none">
