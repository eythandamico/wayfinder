    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col">
        ...
        <PageSection pad="lg">
          <Stack gap="md">
            ...
            <p className="max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
              ...
              <code className="text-[13px] text-foreground/80">
                src/components/ds/
              </code>{" "}
        ...
        <PageSection pad="sm">
          ...
          <p className="mt-8 text-center text-[11px] uppercase tracking-[0.22em] text-muted-foreground">
            Back to{" "}
  ...
  return (
    <Stack gap="sm">
      <Row justify="between" align="baseline" gap="md" wrap>
        <span className="text-[10.5px] uppercase tracking-[0.22em] text-foreground/90">
          {label}
        </span>
        {hint ? (
        ...
        <Stack gap="md">
          {(["start", "center", "between", "end"] as const).map((justify) => (
            <Row key={justify} justify={justify}>
              ...
              <span className="rounded-sm bg-foreground/10 px-3 py-1 text-[11px]">
                A
              </span>
              <span className="rounded-sm bg-foreground/10 px-3 py-1 text-[11px]">
                B
  ...
  return (
    ...
    >
      ...
      <Example label="Button · as link" hint="render={<Link />}">
        <Row gap="sm" wrap>
          <Button render={<Link to="/" />}>Back to landing</Button>
        ...
        <div className="relative grid gap-16 md:grid-cols-2">
          <div className="relative h-48">
            <MockCard className="absolute inset-0 -rotate-[3deg]">
              ...
              <pre className="mt-3 text-[13px] leading-[1.65] text-foreground/90">
