...
function BrowserChrome() {
  return (
    <div className="flex items-center gap-3 border-b border-white/5 bg-muted/80 px-3 py-2">
      ...
      <div className="mx-auto inline-flex items-center gap-1.5 rounded-md bg-white/5 px-3 py-1 text-[10.5px] text-muted-foreground">
        <LockIcon />
        shells.wayfinder.ai
      </div>
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 border-b border-white/5 px-3 py-2">
      ...
      <div className="relative w-[420px] max-w-full">
        ...
        />
        <kbd className="absolute right-2 top-1/2 inline-flex -translate-y-1/2 items-center rounded bg-white/[0.08] px-1.5 py-0.5 text-[9.5px] uppercase tracking-wider text-muted-foreground">
          ⌘K
        </kbd>
      </div>
    ...
    >
      <div className="flex items-center gap-3 px-3 pt-3 pb-2">
        <span className="inline-flex items-center gap-2 rounded-md px-1.5 py-1 transition-colors hover:bg-white/[0.04]">
          ...
          <span className="text-[10px] text-muted-foreground">40X</span>
          <ChevronDownIcon className="size-3 text-muted-foreground" />
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col px-2 py-1">
        <div className="grid grid-cols-[1fr_1fr] gap-1 px-1 py-0.5 text-[8.5px] uppercase tracking-wider text-muted-foreground">
          <span>Price</span>
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
          {asks.map(([p, s]) => (
            <div
              key={p}
              className="grid grid-cols-[1fr_1fr] gap-1 px-1 py-[1px] text-[10px] tabular-nums"
            >
              <span className="text-tone-down">{p}</span>
              <span className="text-right text-foreground/80">{s}</span>
            </div>
          ))}
          <div className="my-0.5 grid grid-cols-[1fr_auto] gap-1 border-y border-white/5 bg-white/[0.02] px-1 py-1 text-[10px] tabular-nums">
