...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card relative flex flex-col gap-4 overflow-hidden rounded-2xl bg-card/60 py-5 text-sm text-card-foreground ring-1 ring-inset ring-white/[0.06] transition-colors",
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl p-5 group-data-[size=sm]/card:p-4",
        className,
      )}
      {...props}
    />
