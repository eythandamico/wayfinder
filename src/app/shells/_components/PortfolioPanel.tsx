    ...
    <div className="flex h-full flex-col overflow-hidden rounded-lg bg-muted">
      <div className="scroll-thin flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto px-4 pb-4 pt-6">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <span className="font-heading text-[32px] font-semibold leading-none tabular-nums text-foreground">
            $0.00
          </span>
          <span className="inline-flex items-center gap-1.5 font-mono text-[10.5px] tabular-nums text-muted-foreground">
    ...
    <div ref={ref} className="relative min-w-0 flex-1">
      ...
      >
        ...
        >
          ...
          <span aria-hidden className="font-mono text-[11px] text-muted-foreground">+</span>
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div className="border-t border-white/5 first:border-t-0">
      ...
      >
        <span
          aria-hidden
          className="flex size-7 shrink-0 items-center justify-center rounded-md bg-white/[0.06] font-mono text-[11px] font-semibold text-foreground/90 transition-colors group-hover:bg-white/[0.09]"
        >
          {glyph}
        </span>
      ...
      {open && (
        ...
        >
          ...
          <button
            type="button"
            className="font-mono text-[10.5px] uppercase tracking-wider text-primary transition-[filter] duration-150 ease-out hover:brightness-110"
          >
            {cta} →
          </button>
        </div>
