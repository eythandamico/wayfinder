  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onActivate}
        className="flex h-[var(--ui-h-input)] w-full items-center gap-2 rounded-full bg-white/5 px-4 text-left text-body text-muted-foreground/80 transition-[background-color,color,scale] duration-150 ease-out hover:bg-white/10 active:scale-[0.96]"
      >
